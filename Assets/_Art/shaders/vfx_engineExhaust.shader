...
Shader "vfx_engineExhaust"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin][HDR]_InnerColour("InnerColour", Color) = (2,0,0,0)
		[HDR]_OuterColour("OuterColour", Color) = (2,0.9490196,0,0)
		_Tiling("Tiling", Vector) = (1,0.2,0,0)
		_TilingScalar("Tiling Scalar", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float3 vertexValue = ( ( frac( ( texCoord60.y * _Pulses ) ) * (( _ToggleSwitch0 )?( 0.0 ):( ( _JiggleStrength * Thrust37 ) )) ) * v.ase_normal );
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 lerpResult54 = lerp( _OuterColour , _InnerColour , Gradient46);
				float4 EndColour56 = lerpResult54;
				
				float time15 = 7.03;
				float2 voronoiSmoothId15 = 0;
				float2 texCoord22 = IN.ase_texcoord3.xy * ( _Tiling * _TilingScalar ) + ( _TimeParameters.x * ( float2( -0.3,-1 ) * ( Thrust37 * _NoiseSpeed ) ) );
				float2 coords15 = texCoord22 * 1.85;
				float2 id15 = 0;
				float2 uv15 = 0;
				float fade15 = 0.5;
				float voroi15 = 0;
				float rest15 = 0;
				for( int it15 = 0; it15 <5; it15++ ){
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 voronoiSmoothId15 = 0;
				float Thrust37 = _Thrust;
				float2 texCoord22 = IN.ase_texcoord2.xy * ( _Tiling * _TilingScalar ) + ( _TimeParameters.x * ( float2( -0.3,-1 ) * ( Thrust37 * _NoiseSpeed ) ) );
				float2 coords15 = texCoord22 * 1.85;
				float2 id15 = 0;
				float2 uv15 = 0;
				float fade15 = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 voronoiSmoothId15 = 0;
				float Thrust37 = _Thrust;
				float2 texCoord22 = IN.ase_texcoord.xy * ( _Tiling * _TilingScalar ) + ( _TimeParameters.x * ( float2( -0.3,-1 ) * ( Thrust37 * _NoiseSpeed ) ) );
				float2 coords15 = texCoord22 * 1.85;
				float2 id15 = 0;
				float2 uv15 = 0;
				float fade15 = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 voronoiSmoothId15 = 0;
				float Thrust37 = _Thrust;
				float2 texCoord22 = IN.ase_texcoord1.xy * ( _Tiling * _TilingScalar ) + ( _TimeParameters.x * ( float2( -0.3,-1 ) * ( Thrust37 * _NoiseSpeed ) ) );
				float2 coords15 = texCoord22 * 1.85;
				float2 id15 = 0;
				float2 uv15 = 0;
				float fade15 = 0.5;
...
/*ASEBEGIN
Version=19102
Node;AmplifyShaderEditor.CommentaryNode;59;-2159.601,239.8896;Inherit;False;606;167;Thrust Master;2;36;37;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;58;-346.5883,-895.1152;Inherit;False;784.0128;559.2997;Colour;5;53;52;55;54;56;;1,1,1,1;0;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;22;-906.7944,-261.286;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;-1050.794,-278.286;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;27;-1056.794,-106.286;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;25;-1214.794,-126.286;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;38;-1291.051,424.8274;Inherit;False;37;Thrust;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;41;-827.7545,328.0833;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;40;-680.4888,327.0078;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;15;-674.799,-259.6169;Inherit;True;1;3;1;2;5;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;7.03;False;2;FLOAT;1.85;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.RegisterLocalVarNode;18;-453.3228,-264.8329;Inherit;False;Tex;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;46;-503.7522,322.6306;Inherit;False;Gradient;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;66;870.892,-147.4948;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;65;1056.892,-148.4948;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.NormalVertexDataNode;64;839.892,23.50519;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;71;91.21771,-205.4432;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;69;-131.4115,-221.936;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;70;-101.9912,-145.21;Inherit;False;Constant;_TimeScalar;TimeScalar;9;0;Create;True;0;0;0;False;0;False;0,-2;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.FractNode;63;693.8918,-144.4948;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
